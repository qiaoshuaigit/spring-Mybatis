...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(test2.new Customer(),"customer-1");
        Thread t2 = new Thread(test2.new Customer(),"customer-2");
        Thread t3 = new Thread(test2.new Product(),"product-1");
        Thread t4 = new Thread(test2.new Product(),"product-2");
        t1.start();
        t2.start();
        t3.start();
        t4.start();
